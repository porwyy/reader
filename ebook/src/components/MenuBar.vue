<template>
	<div class="menu-bar">
		<transition name="slide-up">
			<div class="menu-wrapper" :class="{'hide-box-shadow':ifSettingShow || !ifTitleAndMenuShow}" v-show="ifTitleAndMenuShow">
				<div class="icon-wrapper" @click="showSetting(1)">
					<span class="icon-taiyang icon"></span>
				</div>
				<div class="icon-wrapper" @click="showSetting(2)">
					<span class="icon-jindu icon"></span>
				</div>
				<div class="icon-wrapper">
					<span class="icon-mulu icon" @click="showSetting(3)"></span>
				</div>
				<div class="icon-wrapper">
		...
		<trasition name="slide-up">
			<div class="setting-wrapper" v-show="ifSettingShow">
				<div class="setting-font-size" v-if="showTage === 0">
					<div class="preview" 
				...
				<div class="setting-theme" v-else-if="showTage === 1">
				...
				<div class="setting-progress" v-else-if="showTage === 2">
